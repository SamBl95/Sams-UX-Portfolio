...
The keys live in `.claude/settings.json` (project) or `C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/settings.json` (global) — **not** in `.planning/config.json`:
