...
- **Global scope**: `C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/notes/`)
...
2. Glob `C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/notes/` — works in any directory
