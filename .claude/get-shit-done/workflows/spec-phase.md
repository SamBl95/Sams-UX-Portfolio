...
```bash
INIT=$(node "C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/sambl/OneDrive/Documents/my-portfolio-v2/.claude/get-shit-done/templates/spec.md.
